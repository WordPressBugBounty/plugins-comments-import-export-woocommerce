		...
		<div class="wt_column">
			...
			$plugins = array(
				...
				'giftcards_plugin' => array(
					...
					'description' => __('Create and sell customizable digital and physical gift cards in your WooCommerce store. Allow customers to send, schedule, and redeem gift vouchers while you manage store credits and boost sales using flexible gift card options and templates.', 'comments-import-export-woocommerce'),
				...
				'request_quote' => array(
					...
					'description' => __('Set up a WooCommerce quote request system that lets customers request custom pricing. Hide product prices, replace "Add to Cart" with an "Add to quote" button, accept pricing requests, and manage all quotes directly from your store.', 'comments-import-export-woocommerce'),
				...
				'smart_coupons_plugin' => array(
					...
					'description' => __('Create and manage advanced WooCommerce coupons and discounts for your customers. Set up high-converting campaigns like BOGO deals, store credits, gift vouchers, auto-apply and condition-based coupons, and bulk-generate coupon codes to increase sales and customer engagement.', 'comments-import-export-woocommerce'),
				...
				'url_coupons_plugin' => array(
					...
					'description' => __('Generate custom URLs and QR codes for your WooCommerce coupons that are easy to share and automatically apply discounts when clicked. These unique coupon URLs are easy to share and can even be set to add new products to the cart upon clicking.', 'comments-import-export-woocommerce'),
				...
				'sequential_order_plugin' => array(
					...
					'description' => __('Make your WooCommerce order numbers look clean and professional with sequential order numbers. This plugin creates sequential WooCommerce order numbers and lets you set custom order numbers with prefixes, suffixes, and increments, making orders easier to track and manage.', 'comments-import-export-woocommerce'),
				...
				'product_recommendations' => array(
					...
					'description'   => __('Show personalized product recommendations with 10+ popular recommendations templates. Recommend upsells, cross-sells, best-sellers, frequently bought together, and more to increase the average order value and improve the shopping experience.', 'comments-import-export-woocommerce'),
