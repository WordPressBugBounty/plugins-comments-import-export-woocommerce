...
if ( ! class_exists( 'Wt_Bfcm_Twenty_Twenty_Five' ) ) {
	...
	class Wt_Bfcm_Twenty_Twenty_Five {
        ...
        public function __construct() {
            self::$banner_version = WBTE_CMT_IMP_EXP_VERSION; // Plugin version.
            ...
            /**
			 * Show Smart Coupons promotion banner.
			...
			<script type="text/javascript">
				jQuery(document).ready(function($){					
					...
					if ( ! defined( 'WBTE_BFCM_SC_COUPONS_PAGE' ) && ! in_array( 'sc_cpns_page', $hidden_banners, true ) ) {
						...
						$campaign_url = 'https://www.webtoffee.com/product/smart-coupons-for-woocommerce/?utm_source=free_plugin_add_coupon_menu&utm_medium=comment_import_export&utm_campaign=smart_coupons';
						...
						$bulk_plugin_text = sprintf(
							...
							esc_html__( 'Get Plugin Now', 'comments-import-export-woocommerce' ),
							esc_html__( 'Maybe later', 'comments-import-export-woocommerce' )
						);
						?>
					...
					<div class="wt-bfcm-banner-2025 notice is-dismissible">
						<div class="wt-bfcm-banner-body">
							<div class="wt-bfcm-banner-body-img-section">
								<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . 'assets/images/black-friday-2025.svg' ); ?>" alt="<?php esc_attr_e( 'Black Friday Cyber Monday 2025', 'comments-import-export-woocommerce' ); ?>">
							</div>
							<div class="wt-bfcm-banner-body-info">
								<div class="wt-bfcm-never-miss-this-deal">
									<p><?php echo esc_html__( 'Never Miss This Deal', 'comments-import-export-woocommerce' ); ?></p>
								</div>
								<div class="info">
									<p>
									<?php
										printf(
											...
											esc_html__( 'Your Last Chance to Avail %1$s on WebToffee Plugins. Grab the deal before it`s gone!', 'comments-import-export-woocommerce' ),
											'<span>30% ' . esc_html__( 'OFF', 'comments-import-export-woocommerce' ) . '</span>'
										);
									?>
									</p>
								</div>
								<div class="info-button">
									<a href="<?php echo esc_url( self::$promotion_link ); ?>" class="bfcm_cta_button" target="_blank"><?php echo esc_html__( 'View plugins', 'comments-import-export-woocommerce' ); ?> <span class="dashicons dashicons-arrow-right-alt"></span></a>
								</div>
							</div>
						</div>
					</div>
		...
		public function is_show_banner() {
			...
			if ( ! method_exists( 'HW_Product_Comments_Import_Export_CSV', 'is_bfcm_season' ) || ! HW_Product_Comments_Import_Export_CSV::is_bfcm_season() ) {
