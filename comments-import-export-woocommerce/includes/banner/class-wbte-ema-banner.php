 ...
 * @since 2.4.7
 *
 * @package  Comments_Import_Export_For_WooCommerce
 */
...
if ( ! class_exists( 'Wbte_Ema_Banner' ) ) {
    ...
    class Wbte_Ema_Banner {
        ...
        public function enqueue_styles() {
            ...
            wp_enqueue_style('wt-cmt-ema-banner',plugin_dir_url(__FILE__) . 'assets/css/wbte-ema-banner.css',array(),WBTE_CMT_IMP_EXP_VERSION);
            wp_enqueue_script('wt-cmt-ema-banner',plugin_dir_url(__FILE__) . 'assets/js/wbte-ema-banner.js',array('jquery'),WBTE_CMT_IMP_EXP_VERSION,true);

            wp_localize_script('wt-cmt-ema-banner', 'wbte_ema_banner_params', array(
        ...
        public function ema_inject_analytics_script() {
            ...
            $sale_link = 'https://www.webtoffee.com/ecommerce-marketing-automation/?utm_source=free_plugin_analytics_overview_tab&utm_medium=comments_import_export_free&utm_campaign=EMA' ;
                ...
                <div class="wbte_ema_banner_analytics_page">	
                    <div class="wbte_ema_box">						
                        <div class="wbte_ema_text">
                            <img src="<?php echo esc_url( HF_CMT_IM_EX_PATH_URL . 'includes/banner/assets/images/idea_bulb_purple.svg' ); ?>" style="">
                            <span class="wbte_ema_title"><?php esc_html_e( 'Did you know?', 'comments-import-export-woocommerce' ); ?></span>
                            <?php esc_html_e( 'You can boost your store revenue and recover lost sales with automated email campaigns, cart recovery, and upsell popups using the WebToffee Marketing Automation App.','comments-import-export-woocommerce' ); ?>
                        </div>
                        <div class="wbte_ema_actions">
                            <a href="<?php echo esc_url( $sale_link ); ?>" class="btn-primary" target="_blank"><?php esc_html_e( 'Sign Up for Free', 'comments-import-export-woocommerce' ); ?></a>
                            <button type="button" class="notice-dismiss wbte_ema_banner_analytics_page_dismiss">
                                <span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'comments-import-export-woocommerce' ); ?></span>
                            </button>
                        </div>
                    </div>
                </div>
